      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-20 left-0 w-full bg-background-light dark:bg-background-dark border-b border-slate-200 dark:border-slate-800 shadow-xl">
          <div className="flex flex-col p-4 space-y-4">
            <a onClick={() => setIsMenuOpen(false)} className="px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-lg font-medium transition-colors" href="#beneficios">Benefícios</a>
            <a onClick={() => setIsMenuOpen(false)} className="px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-lg font-medium transition-colors" href="#incluido">O que inclui</a>
            <a onClick={() => setIsMenuOpen(false)} className="px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-lg font-medium transition-colors" href="#quem-somos">Sobre Nós</a>
            <a onClick={() => setIsMenuOpen(false)} className="px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-lg font-medium transition-colors" href="#nossos-servicos">Serviços</a>
            <a 
