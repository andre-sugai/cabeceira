          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center gap-4 border-l border-slate-200 dark:border-slate-700 pl-6 ml-2">
              <a 
                ...
                className="text-slate-500 hover:text-primary dark:hover:text-accent transition-colors"
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-20 left-0 w-full bg-background-light dark:bg-background-dark border-b border-slate-200 dark:border-slate-800 shadow-xl">
          <div className="flex flex-col p-4 space-y-4 overflow-y-auto max-h-[calc(100vh-5rem)]">
            ...
            {/* Social Icons Mobile */}
            <div className="flex items-center gap-6 px-4 pt-4 border-t border-slate-200 dark:border-slate-800 mt-2">
              <a 
                href="https://www.instagram.com/cabeceiraater" 
                target="_blank" 
                rel="noopener noreferrer" 
